...
export default function AccountCard({
  ...
  return (
    <div className="relative bg-gradient-card rounded-xl border border-gray-200 overflow-hidden transition-all duration-300 hover:shadow-card-hover">
      ...
      <div className="p-6">
        ...
        <div className="flex justify-between items-start mb-6">
          <div>
            <span className="text-secondary-cyan font-semibold uppercase text-sm">
              {platform}
            </span>
            <div className="mt-2 text-2xl font-bold text-primary-blue">
              ${price}
            </div>
          </div>
          <span className={`
