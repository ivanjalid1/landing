...
export default function UrgencyBanner({
  ...
  return (
    <div className="relative overflow-hidden">
      {/* Banner principal */}
      <div className="bg-gradient-cta text-white py-4 px-4 text-center relative overflow-hidden">
        {/* Efecto de brillo */}
        ...
        <div className="relative z-10">
          ...
          {Object.keys(timeLeft).length > 0 && (
            <div className="flex justify-center items-center space-x-4 mb-3">
              ...
              <div className="bg-gray-900 text-warning border-2 border-warning rounded-lg px-4 py-2 font-mono font-bold">
          ...
          {/* Código de descuento */}
          <div className="inline-block bg-success px-4 py-2 rounded-md font-bold tracking-wider">
            {discountCode}
          </div>
        </div>
      </div>
